...
public class ImageEditorGUI extends JFrame {
    ...
    private void invertImage() {
        ...
        try {
            ...
            editor.addOperation(new InvertOperation(0, 0, width, height));
            showInfo("Invertir toda la imagen agregada al pipeline.");
        } catch (IOException e) {
            showError("No se pudo obtener el tamaño de la imagen para invertir.");
        }
    }
